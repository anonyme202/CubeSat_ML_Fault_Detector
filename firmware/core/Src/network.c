...
#define AI_NETWORK_MODEL_SIGNATURE     "0x6de7814305481b02285e7ffe80f5848e"
...
#define AI_TOOLS_DATE_TIME   "2025-11-10T22:59:55+0100"
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 1300, 1, 1),
    1300, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    gemm_0_bias_array.data = AI_PTR(g_network_weights_map[0] + 512);
    gemm_0_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 512);
    gemm_1_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_1_weights_array.data = AI_PTR(g_network_weights_map[0] + 576);
    gemm_1_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 576);
    gemm_1_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_1_bias_array.data = AI_PTR(g_network_weights_map[0] + 1088);
    gemm_1_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 1088);
    gemm_2_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_2_weights_array.data = AI_PTR(g_network_weights_map[0] + 1120);
    gemm_2_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 1120);
